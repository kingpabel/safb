    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="sec-box">
                ...
                <header>
                    <h2 class="heading">Governing Body Member List</h2>
                </header>
                <div class="contents" >
                        ...
                        @foreach($allMember as $data)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a onclick="return confirm('Are you sure you want to delete this item?');" href='{!! URL::to("admin/member-delete/$data->id") !!}' class="btn-primary">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>

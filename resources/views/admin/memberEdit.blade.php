        ...
        <div class="col-xs-12">
            <div class="sec-box">
                ...
                <div class="contents">
                    ...
                    {!! Form::open(array('url' => "admin/member/$member->id/edit", 'id' => 'member')) !!}
                    <div class="table-box">
                        <table class="table" style="border: 0 !important;">
                            ...
                            <tr>
                                ...
                                <td class="col-md-8"><input type="text" placeholder="Member Name" name="name" required="" class="form-control2" value="{{ $member->name }}">
                            ...
                            <tr>
                                ...
                                <td class="col-md-8"><input type="text" placeholder="Membership Code" name="code" required="" class="form-control2" value="{{ $member->code }}">
                                    &nbsp; <label class="redtext">*</label>
                                </td>
                            </tr>
                        </table><br><br>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#member").submit(function(event) {
                ...
                $.ajax({
                    url: '{!! URL::to("admin/member/$member->id/edit") !!}',
                    type: "POST",
                    data: values,
                    cache: false,
                    beforeSend: function(){

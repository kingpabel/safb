                    ...
                    <div class="table-box">
                        <table class="table" style="border: 0 !important;">
                            ...
                            <tr>
                                ...
                                <td class="col-md-8"><input required="" type="text" placeholder="Start Date" name="start_date" class="form-control3" id="from" value="{{ $export->start_date }}">
                                    &nbsp; <label class="redtext">*</label>
                                </td>
                            </tr>
                            <tr>
                                <th class="col-md-4">End Date</th>
                                <td class="col-md-8"><input required="" type="text" placeholder="End Date" name="end_date" class="form-control3" id="to" value="{{ $export->end_date }}">
                                    &nbsp; <label class="redtext">*</label>
                                </td>
                            </tr>
                            <tr>

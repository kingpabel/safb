            ...
            <div class="sec-box">
                ...
                <div class="contents">
                    <div class="content_header" style="margin-bottom: 2%">
                        {!! Form::open(array('class' => 'form-horizontal', 'url' => 'admin/report-damage')) !!}
                        ...
                        <div class="form-group" id="foodList">
                            <label for="inputEmail3" class="col-sm-2 control-label">Damage Type</label>
                            <div class="col-sm-3">
                                <select class="form-control" name="damage_type_id">
                                    <option value="">Please select a food</option>
                                    @foreach($allDamageType as $damageType)
